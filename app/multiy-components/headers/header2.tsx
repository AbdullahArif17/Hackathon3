          ...
          <div className="flex items-center gap-x-4">
            ...
            <div className="hidden md:flex items-center gap-x-6">
              ...
              <div className="flex items-center gap-x-2 text-[#23A6F0]">
                ...
                <div className="">
                            <Link href={"/register"}>
                            <Button className="p-5 text-white bg-blue-500 hover:bg-blue-400">Become a member<HiArrowRight /></Button>
                            </Link>
                        </div>
              </div>
                        ...
                        <div className="flex items-center gap-x-4">
                          ...
                          <div className="flex flex-col items-center gap-6">
                            ...
                            <div className="flex flex-col gap-3 items-center text-[#23A6F0]">
                              ...
                              <div className="">
                            <Link href={"/register"}>
                            <Button className="p-5 bg-blue-500 text-white">Become a member<HiArrowRight /></Button>
                            </Link>
                        </div>
                            </div>
                          </div>
